<template>
  <div class="wrap">
    <transition name="move">
      <span  v-show="foods.count && foods.count>0" class="decrease icon-remove_circle_outline" @click.stop.prevent="decrease"></span>
    </transition>
      <span class="cart-content" v-show="foods.count && foods.count>0">{{foods.count}}</span>
      <span class="add icon-add_circle"  @click.stop.prevent="add"></span>
